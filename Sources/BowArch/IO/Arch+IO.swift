...
public typealias StateTHandler<M: Monad, State, Input> = EffectStateTHandler<IOPartial<Error>, M, State, Input>
public typealias StateHandler<State, Input> = EffectStateHandler<IOPartial<Error>, State, Input>
...
public typealias WriterTHandler<M: Monad, State: Monoid, Input> = EffectWriterTHandler<IOPartial<Error>, M, State, Input>
public typealias WriterHandler<State: Monoid, Input> = EffectWriterHandler<IOPartial<Error>, State, Input>
...
public typealias ActionHandler<Action, Input> = EffectActionHandler<IOPartial<Error>, Action, Input>
